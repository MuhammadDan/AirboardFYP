...
def create_toolbar():
    ...
    for i, color in enumerate(colors):
        ...
        if i == current_color_index and current_tool_index != tools.index("Eraser"):
            cv2.rectangle(toolbar, (start_x - 2, start_y - 2), (end_x + 2, start_y + box_height + 2), highlight_color,
                          2)
    ...
    for i, tool in enumerate(tools):
        ...
        if i == current_tool_index:
            cv2.rectangle(toolbar, (tool_start_x - 2, start_y - 2), (tool_end_x + 2, start_y + box_height + 2),
                          highlight_color, 2)
                    ...
                    if drawing_mode and current_point[1] > toolbar_height:
                        if current_tool_index == tools.index("Eraser"):
                            ...
                            if len(prev_points) >= 2:
                                ...
                                cv2.line(canvas, prev_points[-2], smooth_point, colors[current_color_index],
                                         brush_thickness)
                            ...
                            if current_tool_index == 1:  # Rectangle
                                cv2.rectangle(preview_shape, (start_x, start_y), current_point,
                                              colors[current_color_index], brush_thickness)
                            else:  # Circle
                                radius = int(calculate_distance((start_x, start_y), current_point))
                                cv2.circle(preview_shape, (start_x, start_y), radius, colors[current_color_index],
                                           brush_thickness)
                else:
